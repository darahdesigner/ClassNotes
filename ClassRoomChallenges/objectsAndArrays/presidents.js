...
//   presidents.forEach(presidents => console.log(presidents.first, presidents.last))
...
*/
// presidents.unshift({first: "Bugs", last:"Bunny", year: 1940, passed: undefined})
// presidents.push({first: "Donovan", last: "Triplett", year: 1995, passed: undefined})

// presidents.forEach(president =>{
//     president.passed === undefined ? console.log(president.first,
//         president.last): null
//     })

//Platinum: Create a new variable called filteredPresidents and use a  filter method to loop through the array

// let filteredPresidents = presidents.filter(president => president.first[0] === president.last[0]);
// console.log(filteredPresidents); //first name initial and last name initial the same
...
//   };
  /*
    Sort Challenge:\    
    Using the sort method, sort the presidents array by the year property
    in ascending order
